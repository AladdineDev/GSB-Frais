 ...
 */
final class Version20211023113640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE LigneFraisHorsForfait CHANGE idFicheFrais idFicheFrais INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE LigneFraisHorsForfait CHANGE idFicheFrais idFicheFrais INT DEFAULT NULL');
